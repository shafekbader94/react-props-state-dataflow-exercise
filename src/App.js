...
class App extends Component {
  ...
  generateCompanyTags(companies){
    ...
    for(let c of companies)
      comapnyArr.push(<Company name={c.name} revenue={c.revenue}/>)
    return comapnyArr
  } 
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-1">
            {/*companies.map(c => <Company name={c.name}/>)*/}
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-2">
            {<Landing user={this.state.user} hottest={this.state.store.find(s=> s.hottest)}/>}
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {this.state.currentPage === "Landing" ? <Landing user={this.state.user} hottest={this.state.store.find(s=> s.hottest)}/> 
            : <Home store = {this.state.store}/>}
          </div>
        </div>
